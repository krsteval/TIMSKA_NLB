...
<b>1.2.	Додавање на нови податоци, односно нови опреми, преку предифинирани шифрарници.<br />
Додавањето е по стого запазен критериум и е имплементирано соодветна валидација на полињата.
